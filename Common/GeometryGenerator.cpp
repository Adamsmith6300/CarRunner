...
GeometryGenerator::MeshData GeometryGenerator::CreateTunnel(float width, float height, float depth, uint32 numSubdivisions){
	MeshData meshData;
	...
	meshData.Indices32.assign(&i[0], &i[30]);
